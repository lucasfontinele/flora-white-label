...
import {
  ...
  type OperationalDashboardRoutesOptions,
} from "./routes/operational-dashboard-routes.js";
...
export type BuildServerOptions = OrganizationsRoutesOptions &
  ...
  OperationalDashboardRoutesOptions;
...
export async function buildServer(options: BuildServerOptions = {}) {
  ...
  await app.register(operationalDashboardRoutes(options));
