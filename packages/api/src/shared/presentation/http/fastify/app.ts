...
import { prescriberRoutes } from "../../../../modules/prescribers/presentation/http/prescriber-routes.js";
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  await app.register(prescriberRoutes);
  ...
  await app.register(operationalDashboardRoutes);
