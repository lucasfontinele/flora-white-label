      ...
      <div className="p-5 md:p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-white/68">{selectedPatient.relationship}</p>
          </div>
        </div>
          ...
          {patients.map((patient) => {
            ...
            return (
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span
                    className={cn(
                      ...
                      selected ? "text-[var(--text-secondary)]" : "text-white/62",
                    )}
                  >
                ...
                {selected ? (
                  <Icon name="check-circle-2" size={18} className="text-[var(--green-700)]" />
                ) : null}
              </button>
            );
          })}
